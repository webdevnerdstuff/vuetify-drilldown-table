...
} }), Lu = Tn(Ou, [["__scopeId", "data-v-0e21e22d"]]), Mu = ["colspan"], Nu = ["colspan"], ju = ["colspan"], Ru = ["colspan"], Wu = ["innerHTML"], zu = Qe({ __name: "ItemSlot", props: { expandOnClick: {}, itemSelectable: {}, items: {}, levels: {}, showExpand: {}, slotProps: {}, density: {}, level: {}, showSelect: {} }, emits: ["click:row", "click:row:checkbox", "update:expanded"], setup(e, { emit: n }) {
