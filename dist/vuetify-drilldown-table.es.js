...
const Te = (a) => {
  ...
  const r = ve(), l = n, t = a, d = X(), u = Se(Symbol.for("vuetify:icons")), p = X(!1), $ = X(t.items), m = X(t.matchColumnWidths), P = X(t.columnWidths || []), x = X(t.sortAscIcon), T = y(() => t.tableModelValue), g = Pe(), K = y(() => function() {
  ...
  const I = y(() => ((c) => {
    ...
    const { colors: Y, column: z, dataTableExpand: J = !1, level: Be, theme: $e } = f, te = { minWidth: z.width ? ae({ str: z.width }) : "auto", width: z.width ? ae({ str: z.width }) : "auto" };
  ...
  return (c, L) => (v(), V(ne, null, [re("tr", { class: M(e(I)) }, [(v(!0), V(ne, null, le(e(K), (f) => {
    return v(), V(ne, { key: f }, [e(r)[`column.${f.key}`] || e(r)[`header.${f.key}`] ? (v(), V("th", { key: 0, class: M(R(f, f.key)), colspan: f.colspan || 1, style: Q(A(f, !0)) }, [W(c.$slots, `header.${f.key}`, { column: f }, void 0, !0)], 14, Wt)) : f.key === "data-table-group" || f.key === "data-table-group" ? (v(), V("th", { key: 1, class: M(R(f, "header-data-table-group")), colspan: f.colspan || 1, style: Q(A(f, !0)), innerHTML: U(f) }, null, 14, _t)) : f.key === "data-table-select" || f.key === "data-table-select" && c.showSelect ? (v(), V("th", { key: 2, class: M(R(f, "header-data-table-select")), colspan: f.colspan || 1, style: Q(A(f, !0)) }, [c.selectStrategy !== "single" ? (v(), j(Ae, { key: 0, class: M(e(C)), density: c.density, focused: !1, indeterminate: e(i), "model-value": e(p), "onUpdate:modelValue": E }, null, 8, ["class", "density", "indeterminate", "model-value"])) : N("", !0)], 14, Gt)) : f.key === "data-table-expand" ? (v(), V("th", { key: 3, class: M(R(f, "data-table-expand")), colspan: f.colspan || 1, style: Q(A(f, !0)), innerHTML: U(f) }, null, 14, It)) : (v(), V("th", { key: 4, class: M(R(f)), colspan: f.colspan || 1, style: Q(A(f)), onClick: (z) => function(J) {
      J.sortable && t.slotProps.toggleSort(J);
    }(f) }, [re("div", { class: M((Y = f.align, Xe({ align: Y }))), style: Q(_(f)) }, [re("span", { innerHTML: U(f) }, null, 8, jt), f.sortable && e(r)["header.sortIcon"] ? (v(), V("span", { key: 0, class: M(h(f.key)) }, [W(c.$slots, "header.sortIcon", {}, void 0, !0)], 2)) : f.sortable ? (v(), j(Ye, { key: 1, class: M(h(f.key)), icon: e(x), size: e(o) }, null, 8, ["class", "icon", "size"])) : N("", !0)], 6)], 14, Ht))], 64);
    var Y;
  }), 128))], 2), c.loaderSettings.loaderType && !e(r).loading ? (v(), j(e(Vt), { key: 0, colors: c.colors, colspan: c.loaderSettings.colspan, height: c.loaderSettings.height, level: c.level, "loader-props": c.loaderProps, "loader-settings": c.loaderSettings, "loader-type": c.loaderSettings.loaderType, loading: c.loaderSettings.loading || !1, "loading-text": c.loaderSettings.loadingText, size: c.loaderSettings.size }, null, 8, ["colors", "colspan", "height", "level", "loader-props", "loader-settings", "loader-type", "loading", "loading-text", "size"])) : N("", !0)], 64));
} }), [["__scopeId", "data-v-d18d56b2"]]), Nt = ["colspan"], Kt = ["colspan"], zt = ["colspan"], Ut = ["colspan"], qt = ["innerHTML"], Yt = Ee(de({ __name: "ItemSlot", props: { expandOnClick: {}, itemSelectable: {}, items: {}, levels: {}, showExpand: {}, slotProps: {}, density: {}, level: {}, showSelect: {} }, emits: ["click:row", "click:row:checkbox", "update:expanded"], setup(a, { emit: n }) {
  const r = ve(), l = n, t = a, d = Se(Symbol.for("vuetify:icons")), u = y(() => t.slotProps.columns), p = y(() => t.slotProps.index), $ = y(() => t.slotProps.isExpanded), m = y(() => t.slotProps.item), P = y(() => t.slotProps.internalItem), x = y(() => t.slotProps.level), T = y(() => t.slotProps.toggleExpand), g = y(() => t.slotProps.toggleSelect), K = y(() => t.itemSelectable), I = y(() => ((i) => {
  ...
  const r = ve(), l = n, t = a, d = X(), u = Pe(), p = X(!1), $ = X(t.items), m = y(() => t.tableModelValue), P = y(() => t.footers.length ? t.footers : t.slotProps.columns);
  ee(() => t.items, (i) => {
  ...
  return (g, K) => e(r).top ? W(g.$slots, "top", q(ie({ key: 0 }, e($)))) : (g.showSearch || e(r)["top.left"] || e(r)["top.right"]) && e(u) ? (v(), j(ce, { key: 1, lg: "12" }, { default: O(() => [ge(qe, { "data-id": `vdt-top-id-${t.level}` }, { default: O(() => [e(r)["top.left"] ? W(g.$slots, "top.left", q(ie({ key: 0 }, e($)))) : g.showSearch ? (v(), j(ce, { key: 1, class: M(["d-flex align-center justify-end", e(T)]) }, { default: O(() => [g.showSearch ? (v(), j(At, ie({ key: 0 }, e(x), { modelValue: e(d), "onUpdate:modelValue": K[0] || (K[0] = (I) => pt(d) ? d.value = I : null), class: "mt-0 pt-0" }), null, 16, ["modelValue"])) : N("", !0)]), _: 1 }, 8, ["class"])) : N("", !0), e(r)["top.right"] ? W(g.$slots, "top.right", q(ie({ key: 2 }, e($)))) : N("", !0)]), _: 3 }, 8, ["data-id"])]), _: 3 })) : N("", !0);
} });
function Ne(a) {
...
function ao(a, n = {}) {
  ...
  return (u) => {
    ...
    return r && d(r), p <= 0 || $ !== void 0 && $ <= 0 ? (l && (d(l), l = null), Promise.resolve(u())) : new Promise((m, P) => {
      t = n.rejectOnCancel ? P : m, $ && !l && (l = setTimeout(() => {
        r && d(r), l = null, m(u());
      }, $)), r = setTimeout(() => {
        l && d(l), l = null, m(u());
      }, p);
...
const me = /* @__PURE__ */ new Map(), so = ["colspan"], ko = de({ __name: "VDrilldownTable", props: gt({ colorPercentageChange: {}, colorPercentageDirection: {}, colors: {}, columnWidths: {}, customFilter: {}, customKeyFilter: {}, defaultColors: {}, density: {}, drilldown: {}, drilldownKey: {}, elevation: {}, expandOnClick: {}, expanded: {}, filterKeys: {}, filterMode: {}, fixedFooter: { type: Boolean }, fixedHeader: { type: Boolean }, footerBackgroundColor: {}, footerColor: {}, footers: {}, groupBy: {}, headerBackgroundColor: {}, headerColor: {}, headers: {}, height: {}, hideNoData: {}, hover: {}, isDrilldown: { type: Boolean }, item: {}, itemChildrenKey: {}, itemSelectable: {}, itemValue: {}, items: {}, itemsLength: {}, itemsPerPage: {}, itemsPerPageOptions: {}, level: {}, levels: {}, loaderProps: {}, loaderSize: {}, loaderType: { type: [String, Array, Boolean, null] }, loading: {}, loadingText: {}, matchColumnWidths: { type: Boolean }, modelValue: {}, multiSort: {}, mustSort: {}, noDataText: {}, noFilter: {}, page: {}, returnObject: {}, search: {}, searchContainerCols: {}, searchDebounce: {}, searchMaxWait: {}, searchProps: {}, separator: {}, server: { type: Boolean }, selectStrategy: {}, showDrilldownWhenLoading: { type: Boolean }, showExpand: {}, showFooterRow: { type: Boolean }, showSearch: { type: Boolean }, showSelect: {}, sortAscIcon: {}, sortBy: {}, tableType: {}, width: {} }, { ...Je }), emits: ["click:row", "click:row:checkbox", "update:expanded", "update:drilldown", "update:options", "update:itemsPerPage", "update:page", "update:search", "update:sortBy"], setup(a, { emit: n }) {
  const r = n, l = a, t = Se(lt, {}), d = X({ ...l, ...t }), { colorPercentageChange: u, colorPercentageDirection: p, elevation: $, expandOnClick: m, footerBackgroundColor: P, footerColor: x, headerBackgroundColor: T, headerColor: g, hover: K, itemsPerPageOptions: I, loaderProps: R, loaderType: F, separator: A, sortAscIcon: _ } = yt(d.value), i = ve(), E = vt(), C = ft(null), h = y(() => l.density);
  Ue(() => {
  ...
  const U = { ...l, ...o }, c = X(E["data-vdt-id"] ?? `v-drilldown-table-${Date.now()}`), L = X(""), f = Pe(), Y = y(() => o.sortBy), z = y(() => !!o.loading || o.hideNoData);
  (function(s, k, G) {
...
function Fo(a = {}) {
  return { install: (n) => {
    n.provide(lt, a), n.component("VDrilldownTable", xt(() => import("./VDrilldownTable-BA2hnfOR.mjs")));
  } };
}
export {
